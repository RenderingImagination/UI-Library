pcall(function()
	game:GetService('CoreGui')['GameLoadedUI']:Destroy()
end)
...
local m2 = Drawing.new('Circle')
m2.Thickness = 1
m2.Filled = true
m2.NumSides = 25
m2.Radius = 2
m2.Color = Color3.new(0.45098,0.898039,1)
runService.Stepped:connect(function()
	pcall(function()
		m2.Position = Vector2.new(m.X,m.Y+35)
		m2.Visible = game:GetService('CoreGui').GameLoadedUI.Enabled
	end)
end)
